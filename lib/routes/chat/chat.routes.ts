...
import {createChat,updateChat,listConversations,listMessages,updateOfferStatus, markAllRead, getParticipipant} from '@/lib/controllers/chat/chat.controller'
...
router.get('/getParticipipant',getParticipipant)
export { router };      